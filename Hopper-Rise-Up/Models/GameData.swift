...
class GameData: ObservableObject {
    @Published var balls: [BallItem] = [
        ...
        BallItem(id: "ball3", name: "Silver Ball", price: 300, isUnlocked: false),
        BallItem(id: "ball4", name: "Rainbow Ball", price: 800, isUnlocked: false),
    ...
    private func generateLevels() {
        levels = (1...9).map { level in
            LevelData(
                id: level,
                isUnlocked: level == 1, // Тільки перший рівень розблокований
                stars: 0,
                bestScore: 0
            )
        }
